...
class ForaAdapter(BaseAdapter):
    def normalize(self, json_response, media_proxy):
        ...
        return {
            ...
            "media": {"raw_main_image": raw_main_image_url, "raw_gallery": raw_gallery_urls,
                      "main_image": new_gallery[0] if new_gallery else None, "gallery": new_gallery},
            "measurements": self.parse_measurements(raw_data.get('unit')),
            "pricing_logic": {"sales_unit": "weight" if raw_data.get('isWeightedProduct') else "piece",
                              "unit_step": raw_data.get('unitStep', 1)},
            "specific_attributes": {"calories": attributes['calories'],
            ...
            "offers": [{
                ...
                "pricing": {"regular_price": regular_price, "current_price": current_price,
                            "discount_percent": discount_percent, "is_online_only": False, "promo_end_date": None,
                            "bulk_discounts": []},
